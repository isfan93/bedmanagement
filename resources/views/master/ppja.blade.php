                  ...
                  @foreach ($ppjas as $perawat)
                    <tr>
                      ...
                      <td width="10px"><div class="btn-group">
                        <a href="" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Edit perawat: {{$perawat->namaperawat}}"><i class="fas fa-edit"></i></a>
                        @if ($perawat->is_active==1)
                          <a href="" type="button" class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="Nonaktifkan perawat: {{$perawat->namaperawat}}"><i class="fas fa-times-circle"></i></a>
                          @else
                          <a href="" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Aktifkan perawat: {{$perawat->namaperawat}}"><i class="fas fa-check"></i></a>
                        @endif
