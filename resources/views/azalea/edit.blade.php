            ...
            <form>
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    @csrf
                      <input value="{{$trxPasien->trx_id}}" id="trx_id" name="trx_id" type="hidden" class="form-control">
                      ...
                      <div class="form-group">
                        ...
                        <textarea required id="alamat" name="alamat" type="text" class="form-control" placeholder="Alamat pasien..." rows="4">{{ $trxPasien->alamatpasien }}</textarea>
                      </div>
                  </div>
                  {{-- ROW 2 ---------------------------------------------------------------------------------------------------------- --}}
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="form-group">
                        ...
                        <input required id="diagnosa" name="diagnosa" type="text" value="{{ $trxPasien->diagnosa }}" class="form-control" placeholder="Diagnosa awal...">
                      </div>
                  </div>
                  {{-- ROW 4 ---------------------------------------------------------------------------------------------------------- --}}
                  <div class="col-md-3">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="keterangan" name="keterangan" type="text" value="{{ $trxPasien->keterangan }}" class="form-control" placeholder="Keterangan..." rows="3"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
