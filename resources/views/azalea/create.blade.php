            ...
            <div class="card-body">
              <div class="row">
                  ...
                  @csrf
                    <div class="form-group">
                      ...
                      <select required id="bedbooking" name="bedbooking" class="form-control select2bs4" style="width: 100%;">
                        ...
                        @foreach ($beds as $bed)
                          <option value="{{ $bed->id }}">{{ $bed->ruangan }} {{ $bed->namabed }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea required id="alamat" name="alamat" type="text" class="form-control" placeholder="Alamat pasien..." rows="2"></textarea>
                    </div>
                </div>
                {{-- ROW 2 ---------------------------------------------------------------------------------------------------------- --}}
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <label for="keterangan">Alamat pasien</label>
