      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url('perinatologi') }}">perinatologi</a></li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a href="{{ url('perinatologi')}}" class="btn btn-info btn-sm"> <i class="fas fa-arrow-left"> </i> Kembali</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card card-info card-outline">
            ...
            <form action="{{ route('perinatologi.updateDatapasien', $trxPasien->trx_id) }}" method="post">
              <div class="card-body">
                <div class="row">
                  {{-- ROW 1 ---------------------------------------------------------------------------------------------------------- --}}
                  <div class="col-sm-6">
        ...
        <div class="col-md-5">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <form action="{{ route('perinatologi.updateDataMedisPasien', $trxPasien->trx_id) }}" method="post">
                @csrf
              {{-- ROW 2 ---------------------------------------------------------------------------------------------------------- --}}
              <div class="row">
                <div class="col-md-6">
        ...
        <div class="col-md-3">
          <div class="card card-danger card-outline">
            ...
            <div class="card-body">
              <form action="{{ route('perinatologi.updatePpjaPasien', $trxPasien->trx_id) }}" method="post">
                @csrf
              <div class="form-group">
          ...
          <div class="card card-danger card-outline">
            ...
            <div class="card-body">
              <form action="{{route('perinatologi.hci',$trxPasien->trx_id)}}" method="post">
              @csrf
              @method('put')
              <div class="row">
                <div class="col-sm-9">
                ...
                <div class="card-footer">
                  <div class="row">
                    <div class="col-sm-6">
                      <a href="#" class="btn btn-sm btn-warning toastrDefaultError">STOP WAKTU INFUS</a>
                    </div>
                    <div class="col-sm-6">
                      <div class="text-right">
