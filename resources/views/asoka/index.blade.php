    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-9">
          ...
          @include('asoka.kelas1')

          @include('asoka.kelas3')
...
{{-- @if ($tcis->count() != '0')
  <script>
    function playAudio() {
      ...
      var audio = new Audio("{{ asset('adminlte/src/notif.mp3') }}"); // Replace with the actual path to your audio file
    }
