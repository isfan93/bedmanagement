...
class asokaController extends Controller
{
    public function index()
    {
        ...
        $bedVvip    = Bed::with('trxPasien')
                        ...
                        ->where('kelas','vvip')
                        ->get();
        $jmlBedVvip = Bed::where('ruangan','asoka')
                        ->where('kelas','kelas 3')
                        ->count();
        ...
        $bedUtama    = Bed::with('trxPasien')
                        ...
                        ->where('kelas','UTAMA')
                        ->get();
        $jmlBedUtama = Bed::where('ruangan','asoka')
                        ->where('kelas','UTAMA')
                        ->count();
        ...
        $bedKelas1    = Bed::with('trxPasien')
                        ...
                        ->where('kelas','kelas 1')
                        ->get();
        $jmlBedKelas1 = Bed::where('ruangan','asoka')
                        ->where('kelas','kelas 1')
                        ->count();

        $bedKosong = Bed::where('ruangan','asoka')
                        ->where('bedstatus',0)
                        ->count();

        $bedRTC = Bed::where('ruangan','asoka')
                        ->where('bedstatus',3)
                        ->count();

        $bedRP = Bed::where('ruangan','asoka')
                        ->where('bedstatus',2)
                        ->count();

        $pxM = Bed::where('ruangan','asoka')
                        ->where('bedstatus',7)
                        ->count();

        $pxF = Bed::where('ruangan','asoka')
                        ->where('bedstatus',8)
                        ->count();

        $pxTotal = Bed::where('ruangan','asoka')
        ...
        $kelas3       = Bed::select('m_bed.*','trx_pasien.*')
        ...
        $tci    = tci::where('ruangan','ASOKA')->get();

        return view('asoka.index',[
            'tcis'          => $tci,
            'beds'          => $beds,
            'bedVvip'       => $bedVvip,
    ...
    public function edit(string $id)
    {
        ...
        $ppjas       = ppja::where('unit','asoka')
                        ->orderBY('namaperawat','asc')->get();

        return view('asoka.edit',[
    ...
    public function approveBooking($id)
    {
        ...
        return redirect()->route('asoka.index')->with('success','Pasien dengan nama '.$trxPasien->namapasien.' telah masuk ke Rawat inap asoka!');
    }
    ...
    public function rencanaPulang($id)
    {
        ...
        return redirect()->route('asoka.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di rencanakan pulang!');
    }
    ...
    public function batalrencanaPulang($id)
    {
        ...
        return redirect()->route('asoka.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk rencana pulang!');
    }
    ...
    public function batalranap($id)
    {
        ...
        return redirect()->route('asoka.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk naik ke rawat inap!');
    }
    ...
    public function cleaned($id)
    {
        ...
        return redirect()->route('asoka.index')->with('success','Bed telah selesai di lakukan Cleaning dan siap digunakan!');
    }
    ...
    public function updatebed(Request $request, string $id){
        ...
        return redirect()->route('asoka.index')->with('success','Transaksi Booking pasien berhasil disimpan!');
    }
    ...
    public function updateDatapasien(Request $request, string $id){
        ...
        return redirect()->route('asoka.edit',$id)->with('success','DATA PASIEN telah berhasil di Update!');
    }
    ...
    public function updateDataMedisPasien(Request $request, string $id){
        ...
        return redirect()->route('asoka.edit',$id)->with('success','DATA MEDIS PASIEN telah berhasil di Update!');
    }
    ...
    public function updatePpjaPasien(Request $request, string $id){
        ...
        return redirect()->route('asoka.edit',$id)->with('success','PPJA PASIEN telah berhasil di Update!');
    }
    ...
    public function hci(Request $request, string $id)
    {
        ...
        return redirect()->route('asoka.edit',$id)->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Update!');
    }
    ...
    public function hciClear($id)
    {
        ...
        return redirect()->route('asoka.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Stop!');
    }
}