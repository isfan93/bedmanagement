...
class AllysumController extends Controller
{
    public function index()
    {
        ...
        $bedKris    = Bed::with('trxPasien')
                ->where('ruangan','alyssum')
                ->where('kelas','kris')
                ->get();
        $jmlBedAllysum = Bed::where('ruangan','alyssum')
                ->where('kelas','kris')
                ->count();

        $bedKosong = Bed::where('ruangan','alyssum')
                ->where('bedstatus',0)
                ->count();

        $bedRTC = Bed::where('ruangan','alyssum')
                ->where('bedstatus',3)
                ->count();

        $bedRP = Bed::where('ruangan','alyssum')
                ->where('bedstatus',2)
                ->count();

        $pxM = Bed::where('ruangan','alyssum')
                ->where('bedstatus',7)
                ->count();

        $pxF = Bed::where('ruangan','alyssum')
                ->where('bedstatus',8)
                ->count();

        $pxTotal = Bed::where('ruangan','alyssum')
        ...
        $tci    = tci::where('ruangan','alyssum')->get();

        return view('allysum.index',[
        'tcis'          => $tci,
        'beds'          => $beds,
        'bedKelas2'     => $bedKris,
        'jmlBedAllysum'  => $jmlBedAllysum,
        'bedKosong'     => $bedKosong,
        'bedRTC'        => $bedRTC,
        'bedRP'         => $bedRP,
        'pxTotal'       => $pxTotal,
    ...
    public function edit(string $id)
    {
        ...
        $ppjas       = ppja::where('unit','alyssum')
                        ->orderBY('namaperawat','asc')->get();

        return view('allysum.edit',[
    ...
    public function approveBooking($id)
    {
        ...
        return redirect()->route('allysum.index')->with('success','Pasien dengan nama '.$trxPasien->namapasien.' telah masuk ke Rawat inap akasia!');
    }
    ...
    public function rencanaPulang($id)
    {
        ...
        // notif berhasil
        return redirect()->route('allysum.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di rencanakan pulang!');
    }
    ...
    public function batalrencanaPulang($id)
    {
        ...
        return redirect()->route('allysum.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk rencana pulang!');
    }
    ...
    public function batalranap($id)
    {
        ...
        return redirect()->route('allysum.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk naik ke rawat inap!');
    }
    ...
    public function pulangkanPasien($id)
    {
        ...
        return redirect()->route('allysum.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di pulangkan');
    }
    ...
    public function cleaned($id)
    {
        ...
        return redirect()->route('allysum.index')->with('success','Bed telah selesai di lakukan Cleaning dan siap digunakan!');
    }
    ...
    public function updatebed(Request $request, string $id){
        ...
        return redirect()->route('allysum.index')->with('success','Transaksi Booking pasien berhasil disimpan!');
    }
    ...
    public function updateDatapasien(Request $request, string $id){
        ...
        return redirect()->route('allysum.edit',$id)->with('success','DATA PASIEN telah berhasil di Update!');
    }
    ...
    public function updateDataMedisPasien(Request $request, string $id){
        ...
        return redirect()->route('allysum.edit',$id)->with('success','DATA MEDIS PASIEN telah berhasil di Update!');
    }
    ...
    public function updatePpjaPasien(Request $request, string $id){
        ...
        return redirect()->route('allysum.edit',$id)->with('success','PPJA PASIEN telah berhasil di Update!');
    }
    ...
    public function hci(Request $request, string $id)
    {
        ...
        return redirect()->route('allysum.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Update!');
    ...
    public function hciClear($id)
    {
        ...
        return redirect()->route('allysum.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Stop!');
    }
}
