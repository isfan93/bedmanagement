...
class perinatologiController extends Controller
{
    public function index()
    {
        ...
        $bedPerina    = Bed::with('trxPasien')
                        ->where('ruangan','perinatologi')
                        ->where('kelas','intensif anak')
                        ->get();
        $jmlBedPerina = Bed::where('ruangan','perinatologi')
                        ->where('kelas','intensif anak')
                        ->count();

        $bedKosong = Bed::where('ruangan','perinatologi')
                        ->where('bedstatus',0)
                        ->count();

        $bedRTC = Bed::where('ruangan','perinatologi')
                        ->where('bedstatus',3)
                        ->count();

        $bedRP = Bed::where('ruangan','perinatologi')
                        ->where('bedstatus',2)
                        ->count();

        $pxM = Bed::where('ruangan','perinatologi')
                        ->where('bedstatus',7)
                        ->count();

        $pxF = Bed::where('ruangan','perinatologi')
                        ->where('bedstatus',8)
                        ->count();

        $pxTotal = Bed::where('ruangan','perinatologi')
        ...
        $tci    = tci::where('ruangan','PERINATOLOGI')->get();

        return view('perinatologi.index',[
            'tcis'          => $tci,
            'beds'          => $beds,
    ...
    public function edit(string $id)
    {
        ...
        $ppjas       = ppja::where('unit','perinatologi')
                        ->orderBY('namaperawat','asc')->get();

        return view('perinatologi.edit',[
    ...
    public function approveBooking($id)
    {
        ...
        return redirect()->route('perinatologi.index')->with('success','Pasien dengan nama '.$trxPasien->namapasien.' telah masuk ke Rawat inap perinatologi!');
    }
    ...
    public function rencanaPulang($id)
    {
        ...
        return redirect()->route('perinatologi.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di rencanakan pulang!');
    }
    ...
    public function batalrencanaPulang($id)
    {
        ...
        Bed::where('trx_id',$id)->update($bedrencanapulang);
        trxPasien::where('trx_id',$id)->update($rencanapulang);
        return redirect()->route('perinatologi.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk rencana pulang!');
    }
    ...
    public function batalranap($id)
    {
        ...
        return redirect()->route('perinatologi.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk naik ke rawat inap!');
    }
    ...
    public function cleaned($id)
    {
        ...
        return redirect()->route('perinatologi.index')->with('success','Bed telah selesai di lakukan Cleaning dan siap digunakan!');
    }
    ...
    public function updatebed(Request $request, string $id){
        ...
        return redirect()->route('perinatologi.index')->with('success','Transaksi Booking pasien berhasil disimpan!');
    }
    ...
    public function updateDatapasien(Request $request, string $id){
        ...
        return redirect()->route('perinatologi.edit',$id)->with('success','DATA PASIEN telah berhasil di Update!');
    }
    ...
    public function updateDataMedisPasien(Request $request, string $id){
        ...
        return redirect()->route('perinatologi.edit',$id)->with('success','DATA MEDIS PASIEN telah berhasil di Update!');
    }
    ...
    public function hci(Request $request, string $id)
    {
        ...
        return redirect()->route('perinatologi.edit',$id)->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Update!');
    }
    ...
    public function hciClear($id)
    {
        ...
        return redirect()->route('perinatologi.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Stop!');
    }
}