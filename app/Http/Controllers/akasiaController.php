...
class akasiaController extends Controller
{
    public function index()
    {
        ...
        $bedKelas2    = Bed::with('trxPasien')
                        ->where('ruangan','akasia')
                        ->where('kelas','kelas 2')
                        ->get();
        $jmlBedKelas2 = Bed::where('ruangan','akasia')
                        ->where('kelas','kelas 2')
                        ->count();

        $bedKosong = Bed::where('ruangan','akasia')
                        ->where('bedstatus',0)
                        ->count();

        $bedRTC = Bed::where('ruangan','akasia')
                        ->where('bedstatus',3)
                        ->count();

        $bedRP = Bed::where('ruangan','akasia')
                        ->where('bedstatus',2)
                        ->count();

        $pxM = Bed::where('ruangan','akasia')
                        ->where('bedstatus',7)
                        ->count();

        $pxF = Bed::where('ruangan','akasia')
                        ->where('bedstatus',8)
                        ->count();

        $pxTotal = Bed::where('ruangan','akasia')
        ...
        $tci    = tci::where('ruangan','AKASIA')->get();

        return view('akasia.index',[
            'tcis'          => $tci,
            'beds'          => $beds,
            'bedKelas2'     => $bedKelas2,
    ...
    public function edit(string $id)
    {
        ...
        $ppjas       = ppja::where('unit','akasia')
                        ->orderBY('namaperawat','asc')->get();

        return view('akasia.edit',[
    ...
    public function approveBooking($id)
    {
        ...
        return redirect()->route('akasia.index')->with('success','Pasien dengan nama '.$trxPasien->namapasien.' telah masuk ke Rawat inap akasia!');
    }
    ...
    public function rencanaPulang($id)
    {
        ...
        // notif berhasil
        return redirect()->route('akasia.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di rencanakan pulang!');
    }
    ...
    public function batalrencanaPulang($id)
    {
        ...
        return redirect()->route('akasia.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk rencana pulang!');
    }
    ...
    public function batalranap($id)
    {
        ...
        return redirect()->route('akasia.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk naik ke rawat inap!');
    }
    ...
    public function cleaned($id)
    {
        ...
        return redirect()->route('akasia.index')->with('success','Bed telah selesai di lakukan Cleaning dan siap digunakan!');
    }
    ...
    public function updatebed(Request $request, string $id){
        ...
        return redirect()->route('akasia.index')->with('success','Transaksi Booking pasien berhasil disimpan!');
    }
    ...
    public function updateDatapasien(Request $request, string $id){
        ...
        return redirect()->route('akasia.edit',$id)->with('success','DATA PASIEN telah berhasil di Update!');
    }
    ...
    public function updateDataMedisPasien(Request $request, string $id){
        ...
        return redirect()->route('akasia.edit',$id)->with('success','DATA MEDIS PASIEN telah berhasil di Update!');
    }
    ...
    public function hci(Request $request, string $id)
    {
        ...
        return redirect()->route('akasia.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Update!');
    ...
    public function hciClear($id)
    {
        ...
        return redirect()->route('akasia.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Stop!');
    }
}