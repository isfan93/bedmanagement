...
class intensifdewasaController extends Controller
{
    public function index()
    {
        ...
        $bedPerina    = Bed::with('trxPasien')
                        ->where('ruangan','intensif dewasa')
                        ->where('kelas','intensif dewasa')
                        ->get();
        $jmlBedPerina = Bed::where('ruangan','intensif dewasa')
                        ->where('kelas','intensif dewasa')
                        ->count();

        $bedKosong = Bed::where('ruangan','intensif dewasa')
                        ->where('bedstatus',0)
                        ->count();

        $bedRTC = Bed::where('ruangan','intensif dewasa')
                        ->where('bedstatus',3)
                        ->count();

        $bedRP = Bed::where('ruangan','intensif dewasa')
                        ->where('bedstatus',2)
                        ->count();

        $pxM = Bed::where('ruangan','intensif dewasa')
                        ->where('bedstatus',7)
                        ->count();

        $pxF = Bed::where('ruangan','intensif dewasa')
                        ->where('bedstatus',8)
                        ->count();

        $pxTotal = Bed::where('ruangan','intensif dewasa')
        ...
        $perina       = Bed::select('m_bed.*','trx_pasien.*')
        ...
        $tci    = tci::where('ruangan','INTENSIF DEWASA')->get();

        return view('intensifdewasa.index',[
            'tcis'          => $tci,
            'beds'          => $beds,
            'jmlBedPerina'  => $jmlBedPerina,
            'bedPerina'     => $bedPerina,
            'bedKosong'     => $bedKosong,
            'bedRTC'        => $bedRTC,
            'bedRP'         => $bedRP,
    ...
    public function edit(string $id)
    {
        ...
        $ppjas       = ppja::where('unit','intensif dewasa')
                        ->orderBY('namaperawat','asc')->get();

        return view('intensifdewasa.edit',[
    ...
    public function approveBooking($id)
    {
        ...
        return redirect()->route('intensifdewasa.index')->with('success','Pasien dengan nama '.$trxPasien->namapasien.' telah masuk ke Rawat inap intensifdewasa!');
    }
    ...
    public function rencanaPulang($id)
    {
        ...
        return redirect()->route('intensifdewasa.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di rencanakan pulang!');
    }
    ...
    public function batalrencanaPulang($id)
    {
        ...
        return redirect()->route('intensifdewasa.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk rencana pulang!');
    }
    ...
    public function batalranap($id)
    {
        ...
        return redirect()->route('intensifdewasa.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk naik ke rawat inap Intensif Dewasa!');
    }
    ...
    public function cleaned($id)
    {
        ...
        return redirect()->route('intensifdewasa.index')->with('success','Bed telah selesai di lakukan Cleaning dan siap digunakan!');
    }
    ...
    public function updatebed(Request $request, string $id){
        ...
        return redirect()->route('intensifdewasa.index')->with('success','Transaksi Booking pasien berhasil disimpan!');
    }
    ...
    public function updateDatapasien(Request $request, string $id){
        ...
        return redirect()->route('intensifdewasa.edit',$id)->with('success','DATA PASIEN telah berhasil di Update!');
    }
    ...
    public function updateDataMedisPasien(Request $request, string $id){
        ...
        return redirect()->route('intensifdewasa.edit',$id)->with('success','DATA MEDIS PASIEN telah berhasil di Update!');
    }
    ...
    public function hci(Request $request, string $id)
    {
        ...
        return redirect()->route('intensifdewasa.edit',$id)->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Update!');
