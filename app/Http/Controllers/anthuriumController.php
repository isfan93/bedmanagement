...
class anthuriumController extends Controller
{
    public function index()
    {
        ...
        $bedVvip    = Bed::with('trxPasien')
                        ->where('ruangan','anthurium')
                        ->where('kelas','vvip')
                        ->get();
        $jmlBedVvip = Bed::where('ruangan','anthurium')
                        ->where('kelas','vvip')
                        ->count();

        $bedUtama    = Bed::with('trxPasien')
                        ->where('ruangan','anthurium')
                        ->where('kelas','UTAMA')
                        ->get();
        $jmlBedUtama = Bed::where('ruangan','anthurium')
                        ->where('kelas','UTAMA')
                        ->count();

        $bedKelas1    = Bed::with('trxPasien')
                        ->where('ruangan','anthurium')
                        ->where('kelas','kelas 1')
                        ->get();
        $jmlBedKelas1 = Bed::where('ruangan','anthurium')
                        ->where('kelas','kelas 1')
                        ->count();

        $bedKosong = Bed::where('ruangan','anthurium')
                        ->where('bedstatus',0)
                        ->count();

        $bedRTC = Bed::where('ruangan','anthurium')
                        ->where('bedstatus',3)
                        ->count();

        $bedRP = Bed::where('ruangan','anthurium')
                        ->where('bedstatus',2)
                        ->count();

        $pxM = Bed::where('ruangan','anthurium')
                        ->where('bedstatus',7)
                        ->count();

        $pxF = Bed::where('ruangan','anthurium')
                        ->where('bedstatus',8)
                        ->count();

        $pxTotal = Bed::where('ruangan','anthurium')
        ...
        $utama       = Bed::select('m_bed.*','trx_pasien.*')
                        ->leftjoin('trx_pasien', 'trx_pasien.trx_id', '=', 'm_bed.trx_id')
                        ->addSelect(['namadpjp1' => Dokter::select('namadokter')
                            ->whereColumn('id','trx_pasien.dpjp1')
                            ->limit(1)])
        ...
        $kls1       = Bed::select('m_bed.*','trx_pasien.*')
                        ->leftjoin('trx_pasien', 'trx_pasien.trx_id', '=', 'm_bed.trx_id')
                        ->addSelect(['namadpjp1' => Dokter::select('namadokter')
                            ->whereColumn('id','trx_pasien.dpjp1')
                            ->limit(1)])
        ...
        $tci    = tci::where('ruangan','ANTHURIUM')->get();

        return view('anthurium.index',[
            'tcis'          => $tci,
            'beds'          => $beds,
            'bedVvip'       => $bedVvip,
            'jmlBedVvip'    => $jmlBedVvip,
            'bedUtama'      => $bedUtama,
            'jmlBedUtama'   => $jmlBedUtama,
            'bedKelas1'     => $bedKelas1,
            'jmlBedKelas1'  => $jmlBedKelas1,
            'bedKosong'     => $bedKosong,
            'bedRTC'        => $bedRTC,
            'bedRP'         => $bedRP,
            'pxTotal'       => $pxTotal,
    ...
    public function edit(string $id)
    {
        ...
        $ppjas       = ppja::where('unit','anthurium')
                        ->orderBY('namaperawat','asc')->get();

        return view('anthurium.edit',[
    ...
    public function approveBooking($id)
    {
        ...
        return redirect()->route('anthurium.index')->with('success','Pasien dengan nama '.$trxPasien->namapasien.' telah masuk ke Rawat inap anthurium!');
    }
    ...
    public function rencanaPulang($id)
    {
        ...
        return redirect()->route('anthurium.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di rencanakan pulang!');
    }
    ...
    public function batalrencanaPulang($id)
    {
        ...
        return redirect()->route('anthurium.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk rencana pulang!');
    }
    ...
    public function batalranap($id)
    {
        ...
        return redirect()->route('anthurium.index')->with('success','Pasien dengan nama '.$datapasien->namapasien.' telah di batalkan untuk naik ke rawat inap!');
    }
    ...
    public function cleaned($id)
    {
        ...
        return redirect()->route('anthurium.index')->with('success','Bed telah selesai di lakukan Cleaning dan siap digunakan!');
    }
    ...
    public function updatebed(Request $request, string $id){
        ...
        return redirect()->route('anthurium.index')->with('success','Transaksi Booking pasien berhasil disimpan!');
    }
    ...
    public function updateDatapasien(Request $request, string $id){
        ...
        return redirect()->route('anthurium.edit',$id)->with('success','DATA PASIEN telah berhasil di Update!');
    }
    ...
    public function updateDataMedisPasien(Request $request, string $id){
        ...
        return redirect()->route('anthurium.edit',$id)->with('success','DATA MEDIS PASIEN telah berhasil di Update!');
    }
    ...
    public function hci(Request $request, string $id)
    {
        ...
        return redirect()->route('anthurium.edit',$id)->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Update!');
    }
    ...
    public function hciClear($id)
    {
        ...
        return redirect()->route('anthurium.edit', $id )->with('success','WAKTU HABIS CAIRAN INFUS telah berhasil di Stop!');
    }
}